    ...
    <>
      <div className="container skill-page">
        ...
        <div className="text-zone">
          ...
          <p>
            The main area of my expertise is Full Stack Web Development, building modern web applications across both the client and server side. I'm also exploring Artificial Intelligence and Machine Learning to create intelligent, data-driven solutions.
            <br />
            <br />
            • Languages: Java, JavaScript, TypeScript, Python, C, SQL, HTML5, CSS3
            <br />
            <br />
            • Technologies: React.js, Next.js, Node.js, Express.js, Spring Boot, MongoDB, MySQL, PostgreSQL, Tailwind CSS
            <br />
            <br />
            • Tools: Git, GitHub, Docker, VS Code, IntelliJ IDEA, Postman
            <br />
            <br />
            • Coursework: Data Structures & Algorithms, Operating Systems, DBMS, Computer Networks, Software Engineering, AI & ML
          </p>
