import logoName from "../../assets/images/Straight-S.png";
...
function Home() {
  ...
  if (!hasFetched.current) {
    fetch("https://api.counterapi.dev/v1/sarvesh-arun-portfolio-site/visits/up")
      ...
      <div className="home-page">
        ...
        <div className="container ">
          <div className="text-zone">
            ...
            <h2>
              Full Stack Developer | AI/ML Enthusiast | Debugging Life
            </h2>
